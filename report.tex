...
% TTI = Tilted Transverse Anisotropic
...
\begin{figure}[h]
    \caption{A simplified presentation of the main loop for an acoustic wave equation kernel in 1D. Here a point grid \verb|u| at time
    \verb|n+1| is calculated by a weighted combination of nearby points \verb|i+1| and \verb|i-1| in the previous two timesteps \verb|n| and \verb|n-1|}
