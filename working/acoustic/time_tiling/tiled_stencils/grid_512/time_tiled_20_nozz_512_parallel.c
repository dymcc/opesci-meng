      ...
      for (int xx=0;xx<=26;xx++) {
          for (int yy=0;yy<=26;yy++) {
                  for (int time=max(1,4*tt);time<=min(time_size-2,4*tt+3);time++) {
                      ...
                      int t1 = (time + 1) % 8;
                      int t2 = (time - 1) % 8;
                      for (int x=max(4*time+4,20*xx+4*time);x<=min(4*time+527,20*xx+4*time+19);x++) {
                          for (int y=max(4*time+4,20*yy+4*time);y<=min(4*time+527,20*yy+4*time+19);y++) {
                              #pragma ivdep
                              #pragma omp simd
                              for (int z = 4; z < z_size - 4; z += 1) {
                                  float tcse0 = 3.04F*damp[x-skew][y-skew][z];
                                  u[t1][x-skew][y-skew][z] = ((tcse0 - 2*m[x-skew][y-skew][z])*u[t2][x-skew][y-skew][z] - 8.25142857142857e-5F*(u[t0][x-skew][y-skew][z - 4] + u[t0][x-skew][y-skew][z + 4] + u[t0][x-skew][y-skew - 4][z] + u[t0][x-skew][y-skew + 4][z] + u[t0][x-skew - 4][y-skew][z] + u[t0][x-skew + 4][y-skew][z]) + 1.17353650793651e-3F*(u[t0][x-skew][y-skew][z - 3] + u[t0][x-skew][y-skew][z + 3] + u[t0][x-skew][y-skew - 3][z] + u[t0][x-skew][y-skew + 3][z] + u[t0][x-skew - 3][y-skew][z] + u[t0][x-skew + 3][y-skew][z]) - 9.2416e-3F*(u[t0][x-skew][y-skew][z - 2] + u[t0][x-skew][y-skew][z + 2] + u[t0][x-skew][y-skew - 2][z] + u[t0][x-skew][y-skew + 2][z] + u[t0][x-skew - 2][y-skew][z] + u[t0][x-skew + 2][y-skew][z]) + 7.39328e-2F*(u[t0][x-skew][y-skew][z - 1] + u[t0][x-skew][y-skew][z + 1] + u[t0][x-skew][y-skew - 1][z] + u[t0][x-skew][y-skew + 1][z] + u[t0][x-skew - 1][y-skew][z] + u[t0][x-skew + 1][y-skew][z]) + 4*m[x-skew][y-skew][z]*u[t0][x-skew][y-skew][z] - 3.94693333333333e-1F*u[t0][x-skew][y-skew][z])/(tcse0 + 2*m[x-skew][y-skew][z]);
                              }
                          }
                      }
                  }
