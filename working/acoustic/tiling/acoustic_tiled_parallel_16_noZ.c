                    ...
                    for (int x=max(SKEW+4,SKEW+TILE_SIZE*xx);x<=min(x_size-SKFACTOR-1+SKEW, SKEW+TILE_SIZE*xx+TILE_SIZE-1);x++) {
                        for (int y=max(SKEW+4,SKEW+TILE_SIZE*yy);y<=min(y_size-SKFACTOR-1+SKEW, SKEW+TILE_SIZE*yy+TILE_SIZE-1);y++) {
                            ...
                            /*for (int z=max(SKEW+4,SKEW+TILE_SIZE*zz);z<=min(z_size-SKFACTOR-1+SKEW, SKEW+TILE_SIZE*zz+TILE_SIZE-1);z++) {*/
                                ...
                                u[t1][x-SKEW][y-SKEW][z] = ((3.04F*damp[x-SKEW][y-SKEW][z] - 2*m[x-SKEW][y-SKEW][z])*u[t2][x-SKEW][y-SKEW][z] - 8.25142857142857e-5F*(u[t0][x-SKEW][y-SKEW][z - 4] + u[t0][x-SKEW][y-SKEW][z + 4] + u[t0][x-SKEW][y-SKEW - 4][z] + u[t0][x-SKEW][y-SKEW + 4][z] + u[t0][x-SKEW - 4][y-SKEW][z] + u[t0][x-SKEW + 4][y-SKEW][z]) + 1.17353650793651e-3F*(u[t0][x-SKEW][y-SKEW][z - 3] + u[t0][x-SKEW][y-SKEW][z + 3] + u[t0][x-SKEW][y-SKEW - 3][z] + u[t0][x-SKEW][y-SKEW + 3][z] + u[t0][x-SKEW - 3][y-SKEW][z] + u[t0][x-SKEW + 3][y-SKEW][z]) - 9.2416e-3F*(u[t0][x-SKEW][y-SKEW][z - 2] + u[t0][x-SKEW][y-SKEW][z + 2] + u[t0][x-SKEW][y-SKEW - 2][z] + u[t0][x-SKEW][y-SKEW + 2][z] + u[t0][x-SKEW - 2][y-SKEW][z] + u[t0][x-SKEW + 2][y-SKEW][z]) + 7.39328e-2F*(u[t0][x-SKEW][y-SKEW][z - 1] + u[t0][x-SKEW][y-SKEW][z + 1] + u[t0][x-SKEW][y-SKEW - 1][z] + u[t0][x-SKEW][y-SKEW + 1][z] + u[t0][x-SKEW - 1][y-SKEW][z] + u[t0][x-SKEW + 1][y-SKEW][z]) + 4*m[x-SKEW][y-SKEW][z]*u[t0][x-SKEW][y-SKEW][z] - 3.94693333333333e-1F*u[t0][x-SKEW][y-SKEW][z])/(3.04F*damp[x-SKEW][y-SKEW][z] + 2*m[x-SKEW][y-SKEW][z]);
                            }
